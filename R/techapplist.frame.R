...
techapplist.frame=function(techapplist,techlist,caselist){ 
  ...
  techappframe=data.frame(case=case,tech=tech,functional.group=tech.fu,techapp.score=techapp.score)
